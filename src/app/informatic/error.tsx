...
export default function Error({
  ...
  useEffect(() => {
    ...
    console.error("Informatic page error:", error);
  }, [error]);
  ...
  return (
    <div className="bg-bg-primary text-text-primary antialiased min-h-screen">
      <main className="max-w-7xl mx-auto pt-24 md:pt-32 px-md md:px-xl pb-2xl md:pb-4xl">
        <div className="bg-white rounded-xl md:rounded-2xl border border-red-200 p-xl md:p-2xl shadow-lg text-center mx-auto max-w-2xl">
          <AlertCircle
          ...
          <p className="text-gray-600 mb-lg md:mb-2xl font-montserrat text-sm md:text-base">
            We encountered an error loading the informatic page. Please try
